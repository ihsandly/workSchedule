<aside class="w-64 fixed top-0 left-0 bottom-0 bg-slate-100">
    <div class="relative h-full flex flex-col mx-3 my-2 space-y-1.5">
        ...
        <a class="absolute bottom-[20px] right-0 left-0 w-full bg-red-100 hover:bg-red-200 text-red-700 transition-all duration-300 px-1.5 py-1 rounded-lg flex items-center gap-x-1.5"
            href="#">
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-4">
